        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Brownie',
              path: 'brownie',
              builder: (context, params) => const BrownieWidget(),
            ),
            FFRoute(
              name: 'PalhasItalianas',
              path: 'palhasItalianas',
              builder: (context, params) => const PalhasItalianasWidget(),
            ),
            FFRoute(
              name: 'Salgados',
              path: 'salgados',
              builder: (context, params) => const SalgadosWidget(),
            ),
            FFRoute(
              name: 'Carrinho',
              path: 'carrinho',
